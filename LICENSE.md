...
Portions of this code are from VCV Rack SDK 2.4.1, which is copyrighted by VCV. These portions are free software and can be redistributed and/or modifyed under the terms of the 
[GNU General Public License](https://www.gnu.org/licenses/gpl-3.0.en.html) as published by the [Free Software Foundation](https://www.fsf.org/), either version 3 of the License, or any later version.
...
All other code, except those listed in LICENSE-dist.md, are copyrighted by 4ms Company 2024.


The following is the license included with VCV Rack SDK v2.4.1:

TODO: MetaModule SDK will contain a similar license exception clause
...
The **Component Library graphics** for Rack are copyright © 2016-2023 [VCV](https://vcvrack.com/) and licensed under [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/).
...
The **visual design of the Core modules** is copyright © 2016-2023 [VCV](https://vcvrack.com/) and licensed under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/).
